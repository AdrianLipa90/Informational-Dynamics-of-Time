...
| T019C | An admitted event-to-orbit coupling \(\Delta v_M=\chi_M\delta m_n\) updates \(E_M\) and \(h_M\) by the exact impulse formulas | T016A–T019 | algebraic update identity + delta reference tests | `MEMORY_BIFURCATION_CANDIDATE` | Ch. 8 |

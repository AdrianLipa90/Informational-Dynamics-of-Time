...
def test_temporal_primitive_records_relational_tensor_scalar_forcing():
    nodes=_nodes(); assert nodes["TEMPORAL_PRIMITIVE"]["status"]=="ACTIVE_RELATIONAL_TENSOR_SCALAR_FORCING_PHASE_CONNECTION_COMPLEMENT_TARGETED_PASS_CANDIDATE"
def test_downstream_frontier_markers_are_preserved():
    nodes=_nodes(); status=nodes["RETRODICTION"]["status"]

...
def test_temporal_primitive_records_forcing_and_phase_connection():
    status=_nodes()["TEMPORAL_PRIMITIVE"]["status"]
    assert "RELATIONAL_TENSOR_SCALAR_FORCING_TARGETED_PASS" in status
    assert "PHASE_CONNECTION_HOLONOMY_TARGETED_PASS_CANDIDATE" in status

...
\]
The implementation can apply an explicitly supplied maximum admitted condition number and records `WEIGHTED_ILL_CONDITIONED` when that gate is crossed.
...
The executable contract is recorded in `src/idt/retrodiction_uncertainty.py`, with validation receipt `validation/RETRODICTION_UNCERTAINTY_V0_1.json`.
